...
def run(file_id_start=0, file_id_end=4382):
    ...
    for i in range(file_id_start, file_id_end + 1):
        ...
        try:
            with open(chunk, 'rb') as f:
                ...
                print('\r[%.2f%%] updating global dict... (%s)' % (progress, datetime.timedelta(seconds=remaining)) + ' ' * 60, end='')
                sys.stdout.flush()
    ...
    try:
        ...
        with open('pickled_all_%d.pkl' % file_id_start, 'wb') as f:
